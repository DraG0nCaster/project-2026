import { g as getDefaultExportFromCjs } from './index-CghCLudZ.js';
...
const NameInput = ({ onNameChange }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", placeholder: "Enter your name", onChange: (e) => console.log(handleNameChange(e.target.value)) });
};

export { NameInput as default };
//# sourceMappingURL=NameInput-BPPQBtLN.js.map
